            ...
            <div id="select-plan-tabs" class="select-plan-content-wrapper">
              <div class="select-plan-header">
                ...
                <div class="timer-countdown-wrapper">
                  Last chance to get in 5 Hrs: <span class="hight-light">
            ...
            <div class="select-plan-content-wrapper create-account-content-wrapper">
              ...
              <div>
                ...
                <div class="create-account-description">
                  ...
                  <p class="description">
                    We guarantee we will never sell your information and only contact you as needed to provide our
                    service.
                  </p>
                </div>
              </div>
          ...
          <div class="agree-box-wrapper">
            <div class="descrion-wrapper">
              ...
              <div class="description-text-wrapper">
                <p>I agree to the automatic renewal terms above and I confirm I will be billed at $47.89 for the first
