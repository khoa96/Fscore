                  ...
                  <span class="icon-checked">
                    <svg width="24" height="24" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg">
                      ...
                      <g clip-path="url(#clip0_103_3265)">
                        <path d="M7.33337 12L10.6667 15.3333L17.3334 8.66663" stroke="white" stroke-width="2"
                ...
                <div class="create-account-description">
                  <span class="icon">
                    <svg width="20" height="20" viewBox="0 0 20 20" fill="none" xmlns="http://www.w3.org/2000/svg">
                      ...
                      <path d="M7.7688 9.93139L9.34547 11.5089L12.5938 8.26056" stroke="#1A202C" stroke-width="1.5"
                        stroke-linecap="round" stroke-linejoin="round" />
                    </svg>
                  </span>
                  <p class="description">
                            ...
                            <span class="icon-checked">
                              ...
                              <svg width="24" height="24" viewBox="0 0 24 24" fill="none"
                                ...
                                <g clip-path="url(#clip0_103_3381)">
                                  <path d="M7.33331 12L10.6666 15.3333L17.3333 8.66666" stroke="white" stroke-width="2"
                                    stroke-linecap="round" stroke-linejoin="round" />
                                </g>
                                <defs>
                            ...
                            <span class="checked">
                              <span class="icon-checked">
                                ...
                                <svg width="24" height="24" viewBox="0 0 24 24" fill="none"
                                  ...
                                  <rect x="1" y="1" width="22" height="22" rx="11" fill="#3AC5C9" />
                                  <g clip-path="url(#clip0_103_3381)">
                                    <path d="M7.33331 12L10.6666 15.3333L17.3333 8.66666" stroke="white"
                ...
                <span class="icon">
                  ...
                  <svg width="16" height="16" viewBox="0 0 16 16" fill="none" xmlns="http://www.w3.org/2000/svg">
                    <g clip-path="url(#clip0_103_3490)">
                      <path d="M3.33337 8L6.66671 11.3333L13.3334 4.66667" stroke="#718096" stroke-width="1.5"
                        stroke-linecap="round" stroke-linejoin="round" />
                    </g>
                    <defs>
